 ...
 * <li>{@link org.eclipse.emf.ecp.makeithappen.model.task.impl.UserImpl#getTimeOfRegistration <em>Time Of
 * Registration</em>}</li>
...
public class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	public void setNationality(String newNationality) {
		final String oldNationality = nationality;
	...
	public boolean eIsSet(int featureID) {
		...
		case TaskPackage.USER__TIME_OF_REGISTRATION:
			return TIME_OF_REGISTRATION_EDEFAULT == null ? timeOfRegistration != null
				: !TIME_OF_REGISTRATION_EDEFAULT.equals(timeOfRegistration);
		case TaskPackage.USER__WEIGHT:
